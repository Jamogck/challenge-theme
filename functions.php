...
function challenge_conference_theme_scripts() {
	...
	wp_enqueue_style( 'challenge-base-styles', get_template_directory_uri() . '/app.css');

	wp_enqueue_style( 'challenge-font-awesome', 'https://maxcdn.bootstrapcdn.com/font-awesome/4.3.0/css/font-awesome.min.css' );
...
acf_add_local_field_group(array (
	...
	'fields' => array (
		...
		array (
			...
			'label' => 'Apex Experience Content',
			'name' => 'apex_experience_content',
			'type' => 'wysiwyg',
			'instructions' => '',
			'required' => 1,
			'conditional_logic' => 0,
		...
		array (
			...
			'label' => 'Apex Experience Button',
			'name' => 'apex_experience_button',
			'type' => 'repeater',
			'instructions' => '',
			'required' => 0,
			'conditional_logic' => 0,
...
acf_add_local_field_group(array (
	'key' => 'group_5919eb9b86a37',
	'title' => 'Freebie Template',
	'fields' => array (
		array (
			'key' => 'field_5919ec0cf951f',
			'label' => 'Freebie Artwork',
			'name' => 'freebie_artwork',
			'type' => 'image',
			'instructions' => '',
			'required' => 0,
			'conditional_logic' => 0,
...
acf_add_local_field_group(array (
	'key' => 'group_597f4d3444c36',
	'title' => 'Voices Page',
	'fields' => array (
		array (
			'key' => 'field_597f4d3985d58',
			'label' => 'The Speakers',
			'name' => 'the_speakers',
			'type' => 'repeater',
			'instructions' => '',
			...
			'sub_fields' => array (
				...
				array (
					'key' => 'field_597f4d9885d5a',
					'label' => 'Speaker Twitter',
					'name' => 'speaker_twitter',
					'type' => 'text',
					'instructions' => 'The speaker\'s twitter handle (eg. @efcaChallenge).',
					'required' => 0,
					'conditional_logic' => 0,
					'wrapper' => array (
						'width' => '',
